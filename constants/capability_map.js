...
module.exports = {
    'vw-fuel': {
        ...
        measure_range_FALLBACK_2: `status.data_${status_types.LEVELS1}.field_${status_types.TOTAL_RANGE_2}.value`,
        measure_range_FALLBACK_3: `status.data_${status_types.LEVELS2}.field_${status_types.TOTAL_RANGE_2}.value`
    },
    'vw-hybrid': {
        locked: `status.isCarLocked`,
