    ...
    try {
        ...
        objectKeys.forEach((key) => {
            if (Array.isArray(element[key])) {
                ...
                if (path.indexOf("stations.") > -1 && path.indexOf("sessions.") > -1 && key === "id") {
                    adapter.setObjectNotExistsAsync(path + ".stopCharging", {
                        type: "state",
                        common: {
                            name: "Stoppe Ladung",
                            type: "boolean",
                ...
                if (path.indexOf("stations.") > -1 && path.split(".").length === 4 && key === "id") {
                    adapter.setObjectNotExistsAsync(path + ".startCharging", {
                        type: "state",
                        common: {
                            name: "Starte Ladung",
                            type: "boolean",
